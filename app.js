...
async function runClaudeOcr(imageDataUrl, apiKey){
  ...
  const prompt = `Voici la photo d'un document d'état civil de la République de Djibouti : soit un "Extrait d'Acte de Naissance" classique, soit un "Extrait d'Acte de Notoriété Suppletif d'Acte de Naissance" (variante utilisée quand l'acte original est reconstitué).
